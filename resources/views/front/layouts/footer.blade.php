    ...
    <div class="container">
        <div class="row">
            <div class="col-3 col-lg-3 col-sm-3">
                ...
                <div class="p-0 m-0">{!! '<p>hello@aniba.com.sg</p>' !!}</div>
                <!-- <p class="p-0 m-0">+65 9668 8036</p> -->
                <div class="p-0 m-0">{!! '<p>+65 9668 8036</p>' !!}</div>
                <!-- <p class="py-3"> 6 Battery Road #05 - 03 <br>Singapore 049909</p> -->
                <div class="py-3"> {!! '<p>6 Battery Road #05 - 03 <br>Singapore 049909</p>' !!}</div>
            </div>
            <div class="p-0 col-1 col-lg-1 col-sm-1">
                <h6><b>SOCIAL</b></h6>
                <a href="{{ 'https://www.instagram.com/aniba.sg/' }}" target="_blank"><img class="mx-1" src="{{asset('images/instagram.png')}}" width="30" alt=""></a>
                <a href="{{ 'https://www.facebook.com/anibasingapore' }}" target="_blank"><img class="mx-1" src="{{asset('images/facebook.png')}}" width="30" alt=""></a>
            </div>
            <div class="col-3 col-lg-3 col-sm-3">
            ...
            <div class="col-6 col-lg-6 col-sm-6">
                <div class="pt-5">
                    ...
                    <a href="{{ asset('assets/Aniba kosher certification 2022-2023.pdf') }}" target="_blank">
                        <img src="{{ asset('images/logo-footer.png') }}" alt="" style="width: 41px; height: 42px;">
                    </a>
                </div>
            </div>
            <div class="col-6 col-lg-6 col-sm-6">
                <div class="text-end">
                    {{-- @if($logo)
                    <a href="{{ $logo->link }}" target="_blank"><img src="{{asset($logo->logo_footer)}}" width="85px" alt=""></a>
                    @else --}}
