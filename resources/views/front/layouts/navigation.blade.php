<div class="drop">
    ...
    <div class="sidebarNav text-start">
        ...
        @if(count($press) > 0)
        <a class="scrollLink sec9" href="#section8">
            <div class="sidebarNavItem">Press</div>
        </a>
        @endif
        <a class="scrollLink sec10" href="#section9">
            <div class="sidebarNavItem">Gallery</div>
        </a>
    </div>
</div>
<div class="hover d-none">
    ...
    <div class="sidebarNav text-start">
        ...
        @if(count($press) > 0)
        <a class="scrollLink sec9 sidebarNavIn" href="#section8">
            <div class="sidebarNavItem">Press</div>
        </a>
        @endif
        <a class="scrollLink sec10 sidebarNavIn" href="#section9">
            <div class="sidebarNavItem">Gallery</div>
        </a>
    </div>
</div>
@if($logo)
<a href="{{ $logo->link }}" target="_blank" class="foragers-logo d-block"><img class="mb-3" style="position:fixed; bottom: 0;left: 0; z-index: 10;" src="{{asset($logo->logo.'?v='.time())}}" alt=""></a>
@else
