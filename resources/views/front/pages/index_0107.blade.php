        ...
        <div class="d-md-none d-lg-block">
            <div class="modal fade" id="desktopModal" tabindex="-1" aria-labelledby="desktopModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" style="max-width: 360px;">
                    @if($popup)
                    <div class="modal-content" style="border-radius: 0 !important; height: 550px; background: url('{{ $popup->image.'?v=2' }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">
                    @else
        ...
        <div class="mobile d-lg-none d-block">
            <div class="modal fade" id="mobileModal" tabindex="-1" aria-labelledby="mobileModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered h-100" style="max-width: 70%;">
                    @if($popup)
                    <div class="modal-content" style="border-radius: 0 !important; height: 100vw; background: url('{{ $popup->image }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">
                    @else
