...
//section 3
    $(window).scroll(function () {
        ...
        var replace_reservation = $('.section3').offset().top - 200 ;
        if ($(this).scrollTop() > remove_star){  
        ...
        if($(this).scrollTop() > replace_reservation){
        ...
        if($(this).scrollTop() > replace_nav){
            ...
            $('.sidebarNav-reservation').addClass('d-block');
            $('.sidebarNav-reservation').removeClass('d-none');

            $('.sidebarNav').addClass('d-none');
            $('.sidebarNav').removeClass('d-block');

        }else{
            $('.sidebarNav-reservation').addClass('d-none');
            $('.sidebarNav-reservation').removeClass('d-block');
