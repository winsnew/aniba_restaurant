...
<script>
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > nav_trans +340 ) {
            ...
            $(".hover .sec6").css('pointer-events','none');
        } else {
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > nav_trans +360 ) {
            ...
            $(".hover .sec5").css('pointer-events','none');
        } else {
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > nav_trans +390 ) {
            ...
            $(".hover .sec4").css('pointer-events','none');
        } else {
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > nav_trans +410 ) {
            ...
            $(".hover .sec3").css('pointer-events','none');
        } else {
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > nav_trans +450 ) {
            ...
            $(".hover .sec2").css('pointer-events','none');
        } else {
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > nav_trans +470 ) {
            ...
            $(".hover .sec1").css('pointer-events','none');
